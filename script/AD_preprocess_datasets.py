...
# ========================================
# 【配置来源说明】
#   - 通过 run_from_config 调用时：从 TL_settings.jsonc 读取
...
# --- 4. Case配置列表 ---
# 【配置来源说明】
#   - 通过 run_from_config 调用时：从 TL_settings.jsonc 的 cases 区动态生成
...
if __name__ == "__main__":
    ...
    if os.path.exists(config_path):
        ...
        print("[提示] 请确保 TL_settings.jsonc 存在，或从 Python 调用 run_from_config")
        sys.exit(1)
